...
export const services_info = [
  {
    ...
    // We Liaised with back-end and front-end developers. We manage time-sensitive updates, including content changes and database upgrades.
  },
  {
    icon: devops,
    title: "DEV OPS",
    ...
    // The traditional strategy is built around infrequent, large deployments of software, that lends itself to long phases of fixing unforeseen issues and software failures.
  },
  {
    icon: mobile,
    title: "MOBILE",
    ...
    // We work with our expertise engineers to develop and maintain high quality mobile applications.
  },
  {
    icon: data_scientist,
    title: "DATA ENGINEER",
    ...
    // We expertise in designing and developing ETL data pipelines, Big Data/Hadoop applications.
  },
  {
    icon: ai,
    ...
    // We have experience with machine learning frameworks such as Scikit-Learn, Keras, Tensorflow.
  },
  {
    icon: qa,
    ...
    // We carefully process through records and tracking systems, including root cause and corrective actions.
    // and ensures that the final product observes the company’s quality standards.
  },
];
