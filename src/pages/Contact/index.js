              ...
              <div class="row gy-4" >
                ...
                <input type="text" name='name' placeholder="Your Name" onChange={(e)=>{
                  ...
                  {Object.keys(firstNameErr).map((key)=>{
                        return <div style={{color:'red'}} className='fonts'>{firstNameErr[key]}</div>
                  })}
                ...
                <div class="col-md-6">
                <input type = 'text' placeholder='Your Email' name='email' onChange={(e)=>{
                          setEmail(e.target.value)
                        }} className='w-100'/>
                        {Object.keys(emailErr).map((key)=>{
                          return <div style={{color:'red'}} className='fonts'>{emailErr[key]}</div>
                        })}
                </div>

                <div class="col-md-6">
                <input type='text' name='address' placeholder='Your Address' onChange={(e)=>{
                              setLastName(e.target.value)
                            }} className='w-100'/><br/>
                            {Object.keys(lastNameErr).map((key)=>{
                              return <div style={{color:'red'}} className='fonts'>{lastNameErr[key]}</div>
                            })}
                </div>
